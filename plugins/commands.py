...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🌐 BOT Updates 🌐', url='https://t.me/Movie_Finder_Bot07')
            ],
            [
                InlineKeyboardButton('⚡ POWERD BY ⚡', url=f"https://t.me/PROFE07XH"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🚀 POWERD BY 🚀', url='https://t.me/LazyDeveloper')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('🕊️ SUPPORT GRUOP 🕊️', url=f"https://t.me/Movie_Finder_Bot07"),
            InlineKeyboardButton('🚀 OWNER 🚀', url='https://t.me/PROFE07XH')
            ],[
             InlineKeyboardButton('✅ Help ✅', callback_data='help'),
            InlineKeyboardButton('♂️ About ♂️', callback_data='about')
        ]]
